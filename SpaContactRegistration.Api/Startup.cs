...
using Owin;
using SpaContactRegistration.Api.Helpers;
using SpaContactRegistration.Api.Security;
using SpaContactRegistration.Domain.Contracts.Services;
using SpaContactRegistration.Startup;
using System;
using System.Web.Http;

namespace SpaContactRegistration.Api
{
